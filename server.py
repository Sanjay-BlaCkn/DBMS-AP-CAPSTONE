...
def login():
    ...
    if request.method == 'POST':
        ...
        if email == 'bdrops717296@gmail.com' and password == 'DBMS&AP717296':
            a = 'yes'
...
def bl():
    conn = sqlite3.connect('database.db')
    print("Opened database successfully")
    conn.execute('CREATE TABLE IF NOT EXISTS blood (id INTEGER PRIMARY KEY AUTOINCREMENT, type TEXT, donorname TEXT, donorsex TEXT, qty varchar, dweight TEXT, donoremail TEXT, phone TEXT)')
    print( "Table created successfully")
    conn.close()
